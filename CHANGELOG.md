...
## [0.12.12](https://github.com/yarnpkg/pnp-rs/compare/v0.12.11...v0.12.12) - 2026-08-24

### Other

- *(deps)* bump regress to 0.12.0 ([#113](https://github.com/yarnpkg/pnp-rs/pull/113))

## [0.12.11](https://github.com/yarnpkg/pnp-rs/compare/v0.12.10...v0.12.11) - 2026-07-22

### Other

- Fix loose mode fallback resolution ([#110](https://github.com/yarnpkg/pnp-rs/pull/110))

## [0.12.10](https://github.com/yarnpkg/pnp-rs/compare/v0.12.9...v0.12.10) - 2026-06-17

### Other

- replace fancy-regex with regress ([#108](https://github.com/yarnpkg/pnp-rs/pull/108))

## [0.12.9](https://github.com/yarnpkg/pnp-rs/compare/v0.12.8...v0.12.9) - 2026-05-12

### Fixed

- *(fs)* preserve drive root in virtual paths ([#106](https://github.com/yarnpkg/pnp-rs/pull/106))
- *(util)* keep drive prefix sticky when `..` overshoots drive root ([#104](https://github.com/yarnpkg/pnp-rs/pull/104))

### Other

- clean up duplicated code ([#107](https://github.com/yarnpkg/pnp-rs/pull/107))
